...
const Header = () => {
  ...
  const items = [
    ...
    services.map((service,key)=> getItem(
          ...
          <Link to={"dich-vu/chuyen-phat-tieu-chuan-demo"||service.id} className="flex flex-col leading-5">
      ...
      <div className=" lg:static flex justify-around items-center h-full px-4 lg:px-0 container mx-auto text-sm ">
        ...
        <ul className="hidden lg:flex h-full justify-center items-center m-0">
          ...
          <div className="group hover:bg-yellow-200 rounded-md">
            <span
              className={`inline-flex items-center px-4 py-2 ${comparePath("/ve-chung-toi")||comparePath("/cam-ket")} cursor-pointer`}
            >
              Giới thiệu
          ...
          <div className="group hover:bg-yellow-200 rounded-md">
            <span className={`inline-flex items-center  px-4 py-2 ${comparePath("/tra-cuu") } cursor-pointer`}>
              Tra cứu
              <FaChevronDown className="h-4 w-4 pl-[6px]" />
            </span>
            <ul
          ...
          <div className="group hover:bg-yellow-200 rounded-md">
            <Link to="/dich-vu">
            <span className={`inline-flex items-center px-4 py-2 ${comparePath("/dich-vu")||comparePath("chuyen-phat") } cursor-pointer`}>
              Dịch vụ
              <FaChevronDown className="h-4 w-4 pl-[6px]" />
            </span>
            </Link>
          ...
          <div className="group hover:bg-yellow-200 rounded-md">
            <span
              className={`inline-flex items-center px-4 py-2 ${comparePath("/tuyen-dung") || comparePath("/cuoc-song")} cursor-pointer`}
            >
              Tuyển dụng
              <FaChevronDown className="h-4 w-4 pl-[6px]" />
            </span>
          ...
          <div className="group hover:bg-yellow-200 rounded-md">
            <span
              ...
              className={`inline-flex items-center px-4 py-2 ${comparePath("/tu-van") } cursor-pointer`}
            >
              Tư vấn
              <FaChevronDown className="h-4 w-4 pl-[6px]" />
            </span>
