...
const items = [
  ...
  getItem(
    <div>
      <Link to="/khach-hang/thay-doi-mat-khau">
        <div className="text-base font-medium">Đổi mật khẩu</div>
      </Link>
    </div>,
    "2",
  ...
  getItem(
    <div>
      <Link to="/khach-hang/lich-su-dat-hang">
        <div className="text-base font-medium">Lịch sử đặt hàng</div>
      </Link>
    </div>,
    "3",
  ...
  getItem(
    <div>
      <Link to="/khach-hang/thong-bao/don-hang">
  ...
  getItem(
    <div>
      <Link to="/khach-hang/don-dat-hang">
        <div className="text-base font-medium">Đơn đặt hàng</div>
      </Link>
    </div>,
    "5",
  ...
  getItem(
    <div>
      <Link to="/khach-hang/doanh-thu">
        <div className="text-base font-medium">Doanh thu</div>
      </Link>
    </div>,
    "7",
    <FaMoneyCheck className="text-xl ml-[-26px] md:ml-[-16px] lg:ml-0" />
  ),
];
